        ...
        var draggableComponent = {
            ...
            mounted: function mounted() {
                ...
                if ('iscroll' in options) {
                    ...
                    options.scrollFn = this.scrollCustomFn;
                 }
            ...
            methods: {
                scrollCustomFn : function (_this, scrollOffsetX, scrollOffsetY, evt) {
                    this._iscroll.scrollBy(scrollOffsetY, - scrollOffsetX);
                },          
                ...
                onDragStart: function onDragStart(evt) {
                    (this._iscroll) && this._iscroll.disable();
                ...
                onDragEnd: function onDragEnd(evt) {
                    ...
                    (this._iscroll) && this._iscroll.enable();
                }
            }
        };
